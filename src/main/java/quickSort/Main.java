 ...
 *
 * Какой будет сложность алгоритма O(n log n) или O(n^2) зависит от опорного элемента,
 * лучше, чтобы он был максимально приближен к медиане, в худщем случаем будет - O(n^2).
 * Зависимость быстродействия от опорного элемента — один из недостатков алгоритма
 *
 * Полезные ссылки:
